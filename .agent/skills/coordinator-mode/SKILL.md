...
- Advanced multi-agent orchestration with parallel workers, synthesis protocols, and coordinator lifecycle. Use when compl
- Need guidance on: Coordinator Lifecycle
- Need guidance on: Phase-Based Workflow
- Need guidance on: Anti-Patterns
- Need guidance on: Synthesis Protocol
