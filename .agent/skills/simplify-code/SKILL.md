...
- Reduce complexity of over-engineered code. Identify unnecessary abstractions, remove dead code, flatten deep nesting, an
- Working on code-related tasks
- Need guidance on: Core Principle
- Need guidance on: Simplification Checklist
- Need guidance on: Simplification Protocol
- Writing or reviewing bash, javascript, typescript code
