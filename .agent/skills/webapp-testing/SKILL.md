...
**Browser Engine:** This project uses **CloakBrowser** (stealth Chromium) instead of stock Playwright.
Before running tests, ensure stealth browser is ready:
```bash
python .agent/skills/stealth-browser/scripts/stealth_browser.py setup
```
See `stealth-browser` skill for full API reference.
